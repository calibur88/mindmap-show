...
> **文档版本**：v1.3（2026-09-09）· 插件版本：1.2.0
> **版本兼容性**：1.2.0与1.0.0完全兼容，`.mms`语法v1自本版起固定。存量`data.json`缺新字段时自动补默认值（加载时与`DEFAULT_SETTINGS`浅合并）。
...
├─ docs/                   .mms语言规范
├─ test/                   单测目录（镜像src/结构，96例）
├─ styles.css              全部样式集中一处
├─ manifest.json           插件清单（版本1.2.0）
